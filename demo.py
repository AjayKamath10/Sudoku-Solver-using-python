'''
make the code under while loop a function.
make another function to check for unique elements in all possibilities of a row/column/box and assign it to that cell

eg. 'r1c1': 8, 'r1c2': 3, 'r1c3': 1, 'r1c4': 2, 'r1c5': 5, 'r1c6': [6, 9], 'r1c7': [6, 9], 'r1c8': 4, 'r1c9': [6, 7, 9],

here, 7 is present only in r1c9. thus, that cell must have 7'''
...
def makegrid():
    ...
    '''default input'''
    button11 = Button(root, text = "8", command = lambda : insert(11), width = 2, height = 1)
    ...
    button13 = Button(root, text = "1", command = lambda : insert(13), width = 2, height = 1)
    button13.grid(row = 1, column = 3)
    button14 = Button(root, text = "2", command = lambda : insert(14), width = 2, height = 1)
    button14.grid(row = 1, column = 4)
    button15 = Button(root, text = "5", command = lambda : insert(15), width = 2, height = 1)
    ...
    button18 = Button(root, text = "4", command = lambda : insert(18), width = 2, height = 1)
    ...
    button22 = Button(root, text = "7", command = lambda : insert(22), width = 2, height = 1)
    button22.grid(row = 2, column = 2)
    button23 = Button(root, text = "2", command = lambda : insert(23), width = 2, height = 1)
    ...
    button29 = Button(root, text = "5", command = lambda : insert(29), width = 2, height = 1)
    button29.grid(row = 2, column = 9)
    button31 = Button(root, text = "5", command = lambda : insert(31), width = 2, height = 1)
    ...
    button34 = Button(root, text = "7", command = lambda : insert(34), width = 2, height = 1)
    button34.grid(row = 3, column = 4)
    button35 = Button(root, text = "8", command = lambda : insert(35), width = 2, height = 1)
    ...
    button41 = Button(root, text = "4", command = lambda : insert(41), width = 2, height = 1)
    button41.grid(row = 4, column = 1)
    button42 = Button(root, text = "1", command = lambda : insert(42), width = 2, height = 1)
    ...
    button47 = Button(root, text = "7", command = lambda : insert(47), width = 2, height = 1)
    button47.grid(row = 4, column = 7)
    button48 = Button(root, text = "8", command = lambda : insert(48), width = 2, height = 1)
    ...
    button62 = Button(root, text = "9", command = lambda : insert(62), width = 2, height = 1)
    button62.grid(row = 6, column = 2)
    button63 = Button(root, text = "8", command = lambda : insert(63), width = 2, height = 1)
    ...
    button68 = Button(root, text = "5", command = lambda : insert(68), width = 2, height = 1)
    button68.grid(row = 6, column = 8)
    button69 = Button(root, text = "4", command = lambda : insert(69), width = 2, height = 1)
    ...
    button75 = Button(root, text = "7", command = lambda : insert(75), width = 2, height = 1)
    button75.grid(row = 7, column = 5)
    button76 = Button(root, text = "8", command = lambda : insert(76), width = 2, height = 1)
    ...
    button79 = Button(root, text = "2", command = lambda : insert(79), width = 2, height = 1)
    button79.grid(row = 7, column = 9)
    button81 = Button(root, text = "2", command = lambda : insert(81), width = 2, height = 1)
    ...
    button87 = Button(root, text = "5", command = lambda : insert(87), width = 2, height = 1)
    button87.grid(row = 8, column = 7)
    button88 = Button(root, text = "3", command = lambda : insert(88), width = 2, height = 1)
    ...
    button92 = Button(root, text = "6", command = lambda : insert(92), width = 2, height = 1)
    ...
    button95 = Button(root, text = "2", command = lambda : insert(95), width = 2, height = 1)
    button95.grid(row = 9, column = 5)
    button96 = Button(root, text = "1", command = lambda : insert(96), width = 2, height = 1)
    button96.grid(row = 9, column = 6)
    button97 = Button(root, text = "4", command = lambda : insert(97), width = 2, height = 1)
    ...
    button99 = Button(root, text = "8", command = lambda : insert(99), width = 2, height = 1)
    ...
    '''uncomment to cancel default input'''
...
##                    print(grid)
                    ...
                    #checked.append('r'+str(row)+'c'+str(column))
##                    print(grid)
...
##                                if len(grid[i]) == 1:
##                                    grid[i] = int(grid[i][0])
##                                    print('removed row',i,grid[i])
##                                else:
##                                    grid[i].remove(val)
##                                    print('removed row',i,grid[i])
##                                
    ##                    for i in grid.keys():#column
##                        if str(i)[3] == str(column):
##                            if ( type(grid[i]) == list ) and ( val in grid[i] ):
##                                if len(grid[i]) == 1:
##                                    grid[i] = int(grid[i][0])
##                                    print('removed column',i,grid[i])
##                                else:
##                                    grid[i].remove(val)
##                                    print('removed column',i,grid[i])
##
...
##        for row in range(1,10):
##            for column in range(1,10):
##                if (type(grid['r'+str(row)+'c'+str(column)]) == int) and (str('r'+str(row)+'c'+str(column)) not in checked):
...
##        print('rc',element)
        ...
        val = grid[element]#'r'+str(row)+'c'+str(column)]#-2
        checked.append(element)#'r'+str(row)+'c'+str(column))
...
##                button.configure(text = enter, bg = 'yellow')
...
##        box.append([])
##        for j in range(1,10):
##            box[-1].append(grid['r'+str(i)+'c'+str(j)])
##    for row in range(1,10):
##        for column in range(1,10):
##            text = box[row][column]
##            if 
