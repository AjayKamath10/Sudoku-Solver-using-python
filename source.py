...
def makegrid():
    ...
    button23.grid(row = 2, column = 3,padx = (0,5))
    ...
    button26.grid(row = 2, column = 6,padx = (0,5))
    ...
    button43.grid(row = 4, column = 3,padx = (0,5))
    ...
    button46.grid(row = 4, column = 6,padx = (0,5))
    ...
    button49.grid(row = 4, column = 9,padx = (0,5))
    button51 = Button(root, text = "-", command = lambda : insert(51), width = 2, height = 1)
    button51.grid(row = 5, column = 1, padx = (5,0))
    ...
    button53.grid(row = 5, column = 3,padx = (0,5))
    ...
    button56.grid(row = 5, column = 6,padx = (0,5))
    ...
    button73.grid(row = 7, column = 3,padx = (0,5))
    ...
    button76.grid(row = 7, column = 6,padx = (0,5))
    ...
    button79.grid(row = 7, column = 9,padx = (0,5))
    button81 = Button(root, text = "-", command = lambda : insert(81), width = 2, height = 1)
    button81.grid(row = 8, column = 1, padx = (5,0))
    ...
    button83.grid(row = 8, column = 3,padx = (0,5))
    ...
    button86.grid(row = 8, column = 6,padx = (0,5))
